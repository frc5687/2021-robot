...
public class OI extends OutliersProxy {
    ...
    //Free balls for spindexer
    private JoystickButton freeBalls;
    //Joystick X values
    private double xIn;
    //Joystick Y values
    private double yIn;
    ...
    public OI() {
            ...
            */
            ...
            winchReset = new JoystickButton(translation, 8); //
            ...
            freeBalls = new JoystickButton(raceWheel, 10);
            //POV down
    }
    ...
    public void initializeButtons(DriveTrain drivetrain,
            ...
            Trajectory prt4) {
                    ...
                    aimBTN.whenHeld(new AutoTarget(drivetrain, shooter, hood, this, 64, 5000, true)); 
                    ...
                    freeBalls.whenHeld(new ClearSpindexer(spindexer));
                    //#endregion
            }
