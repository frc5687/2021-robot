...
public class Constants {
    ...
    public static class DriveTrain {
        ...
        public static final double WIDTH = 0.628;
        public static final double LENGTH = 0.628;
        ...
        public static final double MAX_MPSS = 1.5; // accel
        ...
        public static final double PROFILE_CONSTRAINT_ACCEL = 10.0 * Math.PI;
    }
        ...
        public static class Slalom {
            public static final List<Pose2d> waypoints =
                    Arrays.asList(
                            ...
                            new Pose2d(1.32, 0.65, Rotation2d.fromDegrees(45)),
                            new Pose2d(2.1, 1.3, Rotation2d.fromDegrees(0)),
                            new Pose2d(5.1, 1.3, Rotation2d.fromDegrees(0)),
                            new Pose2d(5.54, 0.65, Rotation2d.fromDegrees(-60)),
                            new Pose2d(6.5, 0.0, Rotation2d.fromDegrees(0)),
                            new Pose2d(7.1, 0.65, Rotation2d.fromDegrees(90)),
                            new Pose2d(6.5, 1.3, Rotation2d.fromDegrees(180)),
                            new Pose2d(5.54, 0.65, Rotation2d.fromDegrees(-120)),
                            new Pose2d(5.1, 0.0, Rotation2d.fromDegrees(180)),
                            new Pose2d(1.7, 0.0, Rotation2d.fromDegrees(180)),
                            new Pose2d(1.32, 0.65, Rotation2d.fromDegrees(135)),
                            new Pose2d(0.0, 1.3, Rotation2d.fromDegrees(180)));
