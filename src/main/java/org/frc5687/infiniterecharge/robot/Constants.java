    ...
    public static class AutoPaths {
        public static class Slalom {
            public static final List<Pose2d> waypoints =
                    Arrays.asList(
                            new Pose2d(0.0, 0.0, Rotation2d.fromDegrees(60)),
                            new Pose2d(0.7, 0.5, Rotation2d.fromDegrees(45)),
                            new Pose2d(1.16, 1.0, Rotation2d.fromDegrees(0)),
                            new Pose2d(5.76, 1.0, Rotation2d.fromDegrees(0)),
                            ...
                            new Pose2d(6.1, 0.5, Rotation2d.fromDegrees(-120)),
                            new Pose2d(5.76, 0.0, Rotation2d.fromDegrees(180)),
                            new Pose2d(1.143, 0.0, Rotation2d.fromDegrees(180)),
                            new Pose2d(0.0, 1.0, Rotation2d.fromDegrees(180)));
