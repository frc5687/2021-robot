...
public final class SwerveTrajectoryParameterizer {
    /** Private constructor because this is a utility class. */
    private SwerveTrajectoryParameterizer() {}
    ...
    public static SwerveTrajectory timeParameterizeTrajectory(
        ...
        for (int i = 0; i < points.size(); i++) {
            ...
            constrainedState.heading = headings.get(i);
        ...
        for (int i = points.size() - 1; i >= 0; i--) {
            ...
            while (true) {
                ...
                double newMaxVelocity =
                        Math.sqrt(
                                successor.maxVelocityMetersPerSecond
                                                * successor.maxVelocityMetersPerSecond
        ...
        // trajectory states.
        var states = new ArrayList<SwerveTrajectory.State>(points.size());
        ...
        for (int i = 0; i < constrainedStates.size(); i++) {
            ...
            if (i > 0) {
                ...
                if (Math.abs(accel) > 1E-6) {
                    ...
                    throw new SwerveTrajectoryParameterizer.TrajectoryGenerationException(
                            "Something went wrong at iteration "
                                    + i
        ...
        return new SwerveTrajectory(states);
    }
